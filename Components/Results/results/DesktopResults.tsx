...
const DesktopResults: React.FC<DesktopProps> = ({grub, yelpResult, original, location, allLocs, showMap, random, zoom, details, active, noMatch, loading, sortingHat, refresh, reset, randomeChoice, currentSelect}) => {
